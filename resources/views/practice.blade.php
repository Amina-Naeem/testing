...
<div class="row no-gutters justify-content-center ">
    ...
    <div class="col-md-6 no-gutters">
        <div class="leftside d-flex justify-content-center align-items-center container">
            ...
            <table>
                ...
                <tr class="draggable-elements justify-content-center align-items-center" >
                    <td><i class=" draggable" draggable="true" style="color: #111111; " id="from">From</i></td>
    ...
    <div class="col-md-6 no-gutters">
        <div class="rightside d-flex justify-content-center align-items-center"></div>
    </div>
